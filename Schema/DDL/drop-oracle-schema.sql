...
ALTER TABLE BLOCK_SITES DROP CONSTRAINT BK_BLST;

ALTER TABLE BLOCK_SITES DROP CONSTRAINT SI_BLST;
...
ALTER TABLE BLOCK_SITES DROP CONSTRAINT NN_BLST_BLOCK_SITE_ID;

ALTER TABLE BLOCK_SITES DROP CONSTRAINT NN_BLST_BLOCK_ID;

ALTER TABLE BLOCK_SITES DROP CONSTRAINT NN_BLST_SITE_ID;

ALTER TABLE BLOCK_SITES DROP CONSTRAINT PK_BLST;
...
ALTER TABLE FILE_PARENTS DROP CONSTRAINT TUC_FP_1;
...
ALTER TABLE DATASET_PARENTS DROP CONSTRAINT TUC_DP_1;
...
ALTER TABLE BLOCK_PARENTS DROP CONSTRAINT TUC_BP_1;
...
ALTER TABLE DATASET_ACCESS_TYPES DROP CONSTRAINT NN_DTP_DATASET_TYPE_ID;
