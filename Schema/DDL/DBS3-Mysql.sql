...
CREATE TABLE `PATH_TYPES` (
    ...
    `PATH_TYPE` VARCHAR(100) NOT NULL,
...
CREATE TABLE `PATHS` (
    ...
    `IS_PATH_VALID` NUMERIC(1) NOT NULL DEFAULT 1,
    `PRIMARY_DS_ID` INTEGER NOT NULL,
    `PROCESSED_DS_ID` INTEGER NOT NULL,
    `DATA_TIER_ID` INTEGER NOT NULL,
    `PATH_TYPE_ID` INTEGER NOT NULL,
...
CREATE TABLE `PATH_PROCESS_CONFIGS` (
    `PATH_PROCESS_CONF_ID` INTEGER NOT NULL,
    `PATH_ID` INTEGER NOT NULL,
    `PROCESS_CONFIG_ID` INTEGER NOT NULL,
...
CREATE TABLE `PATH_PARENTS` (
    `PATH_PARENT_ID` INTEGER NOT NULL,
    `THIS_PATH_ID` INTEGER NOT NULL,
...
CREATE TABLE `FILE_PROCESS_CONFIGS` (
    `FILE_PROCESS_CONFIG_ID` INTEGER NOT NULL,
    `FILE_ID` INTEGER NOT NULL,
    `PROCESS_CONFIG_ID` INTEGER NOT NULL,
...
CREATE TABLE `PROCESSING_ERAS` (
    ...
    `PROCESSING_ERA_NAME` VARCHAR(100),
