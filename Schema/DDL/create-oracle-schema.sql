...
GRANT SELECT ON DATASET_TYPES TO CMS_DBS3_READ_ROLE;
GRANT INSERT, UPDATE ON DATASET_TYPES TO CMS_DBS3_WRITE_ROLE;
GRANT DELETE ON DATASET_TYPES TO CMS_DBS3_ADMIN_ROLE;
...
CREATE TABLE DATASETS (
    ...
    PATH_TYPE_ID INTEGER CONSTRAINT NN_DS_PATH_TYPE_ID NOT NULL,
...
CREATE INDEX IDX_DS_4 ON DATASETS (PATH_TYPE_ID);
...
CREATE TABLE DATASET_RUNS (
    PATH_RUN_ID INTEGER CONSTRAINT NN_DR_PATH_RUN_ID NOT NULL,
    ...
    CREATION_DATE INTEGER,
    CREATE_BY VARCHAR2(100),
    CONSTRAINT PK_DR PRIMARY KEY (PATH_RUN_ID)
);
...
ALTER TABLE DATASETS ADD CONSTRAINT DTP_DS 
    FOREIGN KEY (PATH_TYPE_ID) REFERENCES DATASET_TYPES (DATASET_TYPE_ID);
...
ALTER TABLE FILES ADD CONSTRAINT DS_FL 
    FOREIGN KEY (PATH_ID) REFERENCES DATASETS (DATASET_ID) ON DELETE CASCADE;
