...
#Oracle
active.DBS.dbowner = 'CMS_LUM_OWNER'
active.DBS.version = 'DBS_3_0_0'
active.DBS.section_('database')
active.DBS.database.connectUrl = 'oracle://CMS_LUM_WRITER:every1needsLumi!@cmscald'
...
active.DBS.version = 'DBS_3_0_0'
active.DBS.section_('database')
active.DBS.database.connectUrl = 'mysql://yuyi:cmsdbs@cmssrv18.fnal.gov:3307/CMS_DBS3'
#active.DBS.database.connectUrl = 'mysql://dbs3:dbs3_pass@cmssrv49.fnal.gov:3306/CMS_DBS3_ANZ_3'
...
#active.MIGRATE.database.connectUrl = 'mysql://yuyi:cmsdbs@cmssrv18.fnal.gov:3307/CMS_DBS3'
#active.MIGRATE.dbowner = '__MYSQL__'
active.MIGRATE.database.connectUrl = 'oracle://CMS_LUM_WRITER:every1needsLumi!@cmscald'
active.MIGRATE.dbowner = 'CMS_LUM_OWNER'
