if [ -z "$DBS3_ROOT" ]; then
    ...
    export PYTHONPATH=$DBS3_ROOT/DBS/Server/Python/src:$WTBASE/python:$DBS3_ROOT/External/py2-zmq/2.1.7-comp/lib/python2.6/site-packages:$DBS3_ROOT/External/py2-zmq/2.1.7-comp/lib/python2.6/site-packages:$DBS3_ROOT/External/zeromq/2.1.7/lib:$DBS3_ROOT/External/CherryPy-3.1.2:$DBS3_ROOT/External/Cheetah-2.4.0/build/lib.linux-x86_64-2.6:$DBS3_ROOT/External/CherryPy-3.1.2/build/lib:$DBS3_ROOT/External/SQLAlchemy-0.5.8/build/lib:$DBS3_ROOT/External/python-cjson-1.0.5/build/lib.linux-x86_64-2.6:$DBS3_ROOT/External/cx_Oracle-5.0.2/build/lib.linux-x86_64-2.6-11g:$PYTHONPATH
