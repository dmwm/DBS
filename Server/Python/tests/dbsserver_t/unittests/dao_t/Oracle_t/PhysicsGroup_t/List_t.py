...
from dbsserver_t.utils.DBSDataProvider import create_dbs_data_provider, sort_data
...
class List_t(unittest.TestCase):
    ...
    def __init__(self, methodName='runTest'):
        ...
        self.data = self.data_provider.get_physics_group_data()
    ...
    def test02(self):
        """dao.Oracle.PhysicsGroup.List: Basic"""
        result = sort_data(self.dao.execute(self.conn, name="%"), 'physics_group_name')
