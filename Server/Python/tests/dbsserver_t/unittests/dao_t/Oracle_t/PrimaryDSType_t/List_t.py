...
from dbsserver_t.utils.DBSDataProvider import create_dbs_data_provider, strip_volatile_fields, sort_data
...
class List_t(unittest.TestCase):
    ...
    def __init__(self, methodName='runTest'):
        ...
        self.data = self.data_provider.get_primary_ds_type_data()
    ...
    def test02(self):
        """dao.Oracle.PrimaryDSType.List: Basic"""
        result = sort_data(self.dao.execute(self.conn, dsType="%"), 'data_type')
