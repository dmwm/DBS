...
if [ -z "$DBS3_SERVER_ROOT" ]; then
   echo "DBS3_SERVER_ROOT not set" 
    ...
    export DBS_TEST_CONFIG_READER=$DBS3_SERVER_ROOT/control/${1:-cms_dbs}_writer.py
    export DBS_TEST_CONFIG_WRITER=$DBS3_SERVER_ROOT/control/${1:-cms_dbs}_writer.py
