...
db_production_global.threads = 4
...
db_development_global.dbowner = dbs3_p2_i2['databaseOwner']
db_development_global.connectUrl = dbs3_p2_i2['connectUrl']['writer']
...
db_integration_global.dbowner = cms_lum_cmscald['databaseOwner']
db_integration_global.connectUrl = cms_lum_cmscald['connectUrl']['writer']
