...
from dbs.utils.DBSTransformInputType import transformInputType, parseRunRange, run_tuple, addDefaults
...
class Datasets(RESTEntity):
    ...
    def validate(self, apiobj, method, api, param, safe):
        ...
        """
        if method=="GET":
            addDefaults(param, is_dataset_valid='1', processing_version='0',
                        min_cdate='0', max_cdate='0', min_ldate='0',
                        max_ldate='0', cdate='0', ldate='0')
    ...
    @restcall
    def get(self, datasets="", is_dataset_valid=1, parent_dataset="",
            ...
            dataset_access_type="", prep_id="", create_by='',
            last_modified_by='', min_cdate=0, max_cdate=0, min_ldate=0,
            max_ldate=0, cdate=0, ldate=0):
        """
