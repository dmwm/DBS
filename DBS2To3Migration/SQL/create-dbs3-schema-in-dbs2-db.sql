...
GRANT SELECT ON FILE_DATA_TYPES TO CMS_DBS_PRODG_READER_ROLE;
GRANT INSERT, UPDATE ON FILE_DATA_TYPES  TO CMS_DBS_PRODG_WRITER_ROLE;
GRANT DELETE ON FILE_DATA_TYPES  TO CMS_DBS_PRODG_ADMIN_ROLE;
...
GRANT SELECT ON DATASET_ACCESS_TYPES TO CMS_DBS_PRODG_READER_ROLE;
GRANT INSERT, UPDATE ON DATASET_ACCESS_TYPES TO CMS_DBS_PRODG_WRITER_ROLE;
GRANT DELETE ON DATASET_ACCESS_TYPES TO CMS_DBS_PRODG_ADMIN_ROLE;
...
CREATE TABLE BLOCK_SITES (
    BLOCK_SITE_ID INTEGER CONSTRAINT NN_BLST_BLOCK_SITE_ID NOT NULL,
    BLOCK_ID INTEGER CONSTRAINT NN_BLST_BLOCK_ID NOT NULL,
    SITE_ID INTEGER CONSTRAINT NN_BLST_SITE_ID NOT NULL,
    CONSTRAINT PK_BLST PRIMARY KEY (BLOCK_SITE_ID)
);
GRANT SELECT ON BLOCK_SITES TO CMS_DBS_PRODG_READER_ROLE;
GRANT INSERT, UPDATE ON BLOCK_SITES TO CMS_DBS_PRODG_WRITER_ROLE;
GRANT DELETE ON BLOCK_SITES TO CMS_DBS_PRODG_ADMIN_ROLE;
...
GRANT SELECT ON FILE_BUFFERS TO CMS_DBS_PRODG_READER_ROLE;
GRANT INSERT, UPDATE ON FILE_BUFFERS TO CMS_DBS_PRODG_WRITER_ROLE;
GRANT DELETE ON FILE_BUFFERS TO CMS_DBS_PRODG_ADMIN_ROLE;
...
GRANT SELECT ON MIGRATION_REQUESTS TO CMS_DBS_PRODG_READER_ROLE;
GRANT INSERT, UPDATE ON MIGRATION_REQUESTS TO CMS_DBS_PRODG_WRITER_ROLE;
GRANT DELETE ON MIGRATION_REQUESTS TO CMS_DBS_PRODG_ADMIN_ROLE;
...
GRANT SELECT ON MIGRATION_BLOCKS TO CMS_DBS_PRODG_READER_ROLE;
GRANT INSERT, UPDATE ON MIGRATION_BLOCKS TO CMS_DBS_PRODG_WRITER_ROLE;
GRANT DELETE ON MIGRATION_BLOCKS TO CMS_DBS_PRODG_ADMIN_ROLE;
...
GRANT SELECT ON COMPONENT_STATUS TO CMS_DBS_PRODG_READER_ROLE;
GRANT INSERT, UPDATE ON COMPONENT_STATUS TO CMS_DBS_PRODG_WRITER_ROLE;
GRANT DELETE ON COMPONENT_STATUS TO CMS_DBS_PRODG_ADMIN_ROLE;
