...
INSERT INTO DATASET_ACCESS_TYPES (DATASET_ACCESS_TYPE_ID, DATASET_ACCESS_TYPE) values(100, 'UNKOWN_DBS2_TYPE')
...
--INSERT ALL DATASETS AS INVALID (IS_DATASET_VALID==0) and DATASET_ACCESS_TYPE="unknow_DBS2_TYPE" (DATASET_ACCESS_TYPE_ID=100)
...
SELECT B.ID, B.NAME, B.DATASET, B.OPENFORWRITING, 
		     ...
		     PDCB2.DISTINGUISHEDNAME, 'unknow'
...
SELECT FRL.RUN, FRL.LUMI, FRL.FILEID FROM CMS_DBS_PROD_GLOBAL.FILERUNLUMI FRL;
commit;
